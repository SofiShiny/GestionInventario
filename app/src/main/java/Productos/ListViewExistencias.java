...
public class ListViewExistencias extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_view_existencias);

        buscadorProducto=findViewById(R.id.searchViewEliminarExistencias);
        ...
        listViewContacto.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ed.putString("precio",c.getPrecio());
                ...
                ed.putString("uid",c.getIdByD().toString());
                ed.putString("imagen",c.getImagen());

                Intent intent = new Intent(ListViewExistencias.this, EliminarExistenciaActivity.class);
                intent.putExtras(ed);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    for (DataSnapshot ds: dataSnapshot.getChildren()) {
                        ...
                        adapter= new CustomProductosAdapter(ListViewExistencias.this, lista_contacto);
                        listViewContacto.setAdapter(adapter);
                    }
                }
            }
    ...
    private void irHome() {
        Intent intent = new Intent(ListViewExistencias.this, HomeActivity.class);
        startActivity(intent);
        finish();
    }
